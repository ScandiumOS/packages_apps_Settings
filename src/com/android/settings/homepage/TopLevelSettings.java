...
import com.android.settings.scandium.ScandiumWifiHomepagePreferenceController;
import com.android.settings.scandium.TopMenuBatteryController;
...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
    ...
    public void onAttach(Context context) {
        ...
        mBlurStyleEnable = Settings.System.getIntForUser(context.getContentResolver(),
        ...
        mSettingsStyle = Settings.System.getInt(context.getContentResolver(),
                    Settings.System.SETTINGS_STYLE, 0);
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        iteratePreferences(preference -> {
            if (preference instanceof HomepagePreferenceLayout) {
                ...
                ((HomepagePreferenceLayout) preference).getHelper()
                        .setSettingsBlur(mBlurStyleEnable);
            }
        });
        ...
        for (int i = 0; i < getPreferenceScreen().getPreferenceCount(); i++) {
            ...
            if (mSettingsStyle == 1 && visible) {
            	...
            	preference.setLayoutResource(R.layout.homepage_preference_scandium_grid);
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        controllers.add(new ScandiumWifiHomepagePreferenceController(context, lifecycle));
