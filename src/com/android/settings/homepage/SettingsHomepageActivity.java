...
public class SettingsHomepageActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isBlurEnable = mIsBlurEnable = android.provider.Settings.System.getInt(getApplicationContext().getContentResolver(), "blur_style", 0) == 1;
    	CollapsingToolbarLayout collapsingToolbarLayout = findViewById(R.id.homepage_collapsing_toolbar_layout);
        Drawable header = collapsingToolbarLayout.getContentScrim();
    	if (header != null) header.setAlpha(isBlurEnable ? 180 : 255);
    ...
    private void initSearchBarView() {
        ...
        final LinearLayout sLayout = findViewById(R.id.search_layout);
        ...
        mAppBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                float alpha = 1f - offset;
                float blurAlpha = alpha;
                if (alpha > 0.4f) blurAlpha = 0.4f;
                sLayout.setAlpha(mIsBlurEnable ? blurAlpha : alpha);
            }
        });
    }
