...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    private void initHeader() {
        ...
        final View topRound = headerPreference.findViewById(R.id.top_round);
        final RelativeLayout userLayout = headerPreference.findViewById(R.id.user_profile_layout);

        Resources r = getContext().getResources();
        headerView.setBackground(setCustomColor ? null :  r.getDrawable(R.drawable.scandium_bg_gaydient));
        Drawable bg = headerView.getBackground();
        if (bg != null) bg.setTint(colorSurface);
        Drawable userBg = userLayout.getBackground();
                userBg.setTint(customColor);
                userBg.setAlpha(alpha);
