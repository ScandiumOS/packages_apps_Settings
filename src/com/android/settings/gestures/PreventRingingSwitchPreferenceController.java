...
public class PreventRingingSwitchPreferenceController extends AbstractPreferenceController
            ...
            if (pref != null) {
                pref.setOnPreferenceClickListener(preference -> {
                    ...
                    boolean isChecked = preventRinging != null &&
                            !preventRinging.equals(Settings.Secure.SCANDIUM_VOLUME_HUSH_OFF);
                    Settings.Secure.putString(mContext.getContentResolver(),
                            Settings.Secure.VOLUME_HUSH_GESTURE, isChecked
                                    ? Settings.Secure.SCANDIUM_VOLUME_HUSH_OFF
                                    : Settings.Secure.SCANDIUM_VOLUME_HUSH_VIBRATE);
                    return true;
                });
    ...
    public void updateState(Preference preference) {
        ...
        setChecked(preventRingingSetting != null &&
                !preventRingingSetting.equals(Settings.Secure.SCANDIUM_VOLUME_HUSH_OFF));
    }
