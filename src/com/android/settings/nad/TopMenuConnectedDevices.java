/*
 * Copyright (C) 2022 The scandium Project
 *
...
public class TopMenuConnectedDevices extends Preference
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        if (blurStyleEnable) {
            Drawable connectBg = mConnectedDevices.getBackground();
            if (connectBg != null) connectBg.setAlpha(100);
            Drawable bluetoothBg = mBluetoothMenu.getBackground();
            if (bluetoothBg != null) bluetoothBg.setAlpha(100);
            Drawable prefBg = mPrefMenu.getBackground();
            if (prefBg != null) prefBg.setAlpha(100);
        }
    }
