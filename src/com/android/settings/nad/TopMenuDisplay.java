...
public class TopMenuDisplay extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        if (blurStyleEnable) {
            Drawable displayBg = mDisplay.getBackground();
            if (displayBg != null) displayBg.setAlpha(100);
            Drawable darkBg = mDarkMode.getBackground();
            if (darkBg != null) darkBg.setAlpha(100);
            Drawable lockBg = mLockScreens.getBackground();
            if (lockBg != null) lockBg.setAlpha(100);
        }
    }
