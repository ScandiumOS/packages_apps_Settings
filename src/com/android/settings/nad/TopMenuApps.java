...
public class TopMenuApps extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        if (blurStyleEnable) {
            Drawable topBg = mTopMenuApps.getBackground();
            if (topBg != null) topBg.setAlpha(100);
            Drawable allAppsBg = mAllApps.getBackground();
            if (allAppsBg != null) allAppsBg.setAlpha(100);
            Drawable defaultAppsBg = mDefaultApps.getBackground();
            if (defaultAppsBg != null) defaultAppsBg.setAlpha(100);
        }
    }
