...
public class TopMenuStorage extends Preference {
    ...
    private static final String TAG = "ScandiumTopStorageProgress";
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        if (blurStyleEnable) {
            Drawable storage = mStorage.getBackground();
            if (storage != null) storage.setAlpha(100);
            Drawable progressBg = mProgressBar.getBackground();
            if (progressBg != null) progressBg.setAlpha(100);
            Drawable freeUpBg = mFreeUp.getBackground();
            if (freeUpBg != null) freeUpBg.setAlpha(100);
        }
    }
    ...
    public int colorTint() {
    	return mBlurStyleEnable ? Utils.applyAlpha(0.4f, Utils.getColorAttrDefaultColor(getContext(), android.R.attr.colorAccent)) :
