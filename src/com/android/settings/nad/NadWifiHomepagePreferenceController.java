 ...
 */
public class ScandiumWifiHomepagePreferenceController extends AbstractPreferenceController implements
    ...
    public ScandiumWifiHomepagePreferenceController(Context context, Lifecycle lifecycle) {
        super(context);
        if (lifecycle == null) {
