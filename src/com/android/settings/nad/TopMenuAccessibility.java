...
public class TopMenuAccessibility extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        if (blurStyleEnable) {
            Drawable accessibilityBg = mAccessibility.getBackground();
            if (accessibilityBg != null) accessibilityBg.setAlpha(100);
            Drawable dimBg = mExtraDim.getBackground();
            if (dimBg != null) dimBg.setAlpha(100);
            Drawable audioBg = mAudio.getBackground();
            if (audioBg != null) audioBg.setAlpha(100);
        }
    }
