...
public class TopMenuNetwork extends Preference implements
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        if (blurStyleEnable) {
            Drawable internetBg = mInternetMenu.getBackground();
            if (internetBg != null) internetBg.setAlpha(100);
            Drawable airplaneBg = mAirplane.getBackground();
            if (airplaneBg != null) airplaneBg.setAlpha(100);
            Drawable mobileBg = mMobile.getBackground();
            if (mobileBg != null) mobileBg.setAlpha(100);
        }
    }
