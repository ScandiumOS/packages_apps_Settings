...
public class scandiumCardPrefWallBlur extends ImageView {

    Context contextM;

    public scandiumCardPrefWallBlur(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        contextM = context;
        setRenderEffect(RenderEffect.createBlurEffect(30, 30, Shader.TileMode.CLAMP));
    }

    public scandiumCardPrefWallBlur(Context context, AttributeSet attrs) {
        super(context, attrs);
        contextM = context;
        setRenderEffect(RenderEffect.createBlurEffect(30, 30, Shader.TileMode.CLAMP));
    }
    ...
    public scandiumCardPrefWallBlur(Context context) {
        super(context);
        contextM = context;
        setRenderEffect(RenderEffect.createBlurEffect(30, 30, Shader.TileMode.CLAMP));
    }
